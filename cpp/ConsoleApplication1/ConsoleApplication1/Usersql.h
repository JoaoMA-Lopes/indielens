...
void upsertUser(mysqlx::Session& sess, const User& u);

void upsertUserGame(mysqlx::Session& sess, uint64_t steamid, const User& u);

void upsertUserAchievements(mysqlx::Session& sess, CURL* curl, const std::string& apiKey, uint64_t steamid, const User& u);

void ingestone(mysqlx::Session& sess, CURL* curl, const std::string& apiKey, const User& user);